<?
	...
	$arSQL = "SELECT Id, Title, Content, Type, HashTag ";
	$strTB = " FROM Blogs";
...
<div class="body">
	...
	-->
	<form name="tx_editor_form" id="tx_editor_form" action="/My/blogpost.php" method="post" accept-charset="utf-8">
	<input type="hidden" name="Talent_Id" value="<?=$_REQUEST['id']?>">
	제목 : <input type="text" style="width:500px;" name="title">
	<br>
	타입 : <select style="width:200px;" name="type">
				<option value="2">수업TIP</option>
				<?if($Id=='22'){?>
				<option value="4">알림</option>
				<option value="5">이벤트</option>
				<option value="6">튜터소식</option>
				<?}?>
			</select>
	<br>
	<br>
...
<div style="float:right;"><button onclick='saveContent()'>등록하기</button></div>
<!-- End: Saving Contents -->
